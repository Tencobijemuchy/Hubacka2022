...
<!-- Dva stĺpce (rovnaká šírka ako quick select) -->
<div style="background-color: #80a080;" class="container rounded-2 p-3 my-2">
    <div class="row align-items-stretch">

        <!-- PRVÝ STĹPEC -->
        <div class="col-12 col-md-6 mb-3 mb-md-0"><!-- mb-3 na oddelenie stĺpcov na menších zariadeniach -->
            <!-- Carousel -->
            ...
            <div class="h-100 p-3 rounded-2" style="background-color: #80a080;">
                ...
                <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <div class="col-6 d-flex align-items-center justify-content-end pe-2">
                        <label for="amount" class="mb-0 me-2">Amount</label>
                        <input type="number" id="amount" class="form-control" style="width:80px;" min="1" value="1">
                    </div>
                </div>
